    ...
    <div className="bg-white border-2 border-[#1A4331]/15">
      ...
      <div className="p-4 sm:p-6 space-y-6">
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className={`border-2 border-[#1A4331]/20 bg-[#F8F5F0] rounded-none focus-visible:ring-0 focus-visible:border-[#1A4331] text-xs sm:text-sm pr-10 ${errors.oldPassword ? "border-red-500" : ""}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className={`border-2 border-[#1A4331]/20 bg-[#F8F5F0] rounded-none focus-visible:ring-0 focus-visible:border-[#1A4331] text-xs sm:text-sm pr-10 ${errors.newPassword ? "border-red-500" : ""}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className={`border-2 border-[#1A4331]/20 bg-[#F8F5F0] rounded-none focus-visible:ring-0 focus-visible:border-[#1A4331] text-xs sm:text-sm pr-10 ${errors.confirmPassword ? "border-red-500" : ""}`}
        ...
        <Button
          ...
          disabled={loading}
          className="w-full bg-[#1A4331] hover:bg-[#8A9A7A] text-[#F8F5F0] rounded-none font-bold text-xs sm:text-sm"
        >
          {loading ? (
            <>
